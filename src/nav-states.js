window.onload = function () {
  ...
  const elements = {
    ...
    menuIconLines: document.querySelectorAll(".menu-icon1_line-top.white-icon, .menu-icon1_line-middle.white-icon, .menu-icon1_line-bottom.white-icon"), // The lines in the menu icon with white-icon class
  };
